...
type Options struct {
	...
	// MaaSURL is the URL to the Memory-as-a-Service backend for extended memory allocation.
	MaaSURL string

	// MaaSFallbackEnabled enables fallback to local memory if MaaS allocation fails.
	MaaSFallbackEnabled bool
}
